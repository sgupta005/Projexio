...
function StatCard({ title, value, weeklyValue, weeklyColor }: StatCardProps) {
  return (
    <div className="cursor-pointer bg-background border border-gray-200 rounded-lg p-6 shadow-sm md:w-[220px] w-full hover:shadow-md transition-all duration-300">
