...
import { Status, statuses, Task } from '../types.ts';
import { StatusBadge } from './StatusBadge';
import { useParams } from 'react-router-dom';
import { TaskCard } from './TaskCard';
import useSaveTaskPosition from '../hooks/useSaveTaskPosition.ts';
...
function Column({
  ...
  return (
    <div
      ref={setNodeRef}
      className="flex flex-col p-4 bg-muted rounded-lg h-[470px] min-w-[300px] "
    >
